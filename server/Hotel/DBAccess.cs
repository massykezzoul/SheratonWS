...
namespace Hotel
{
    class DBAccess
    {
        ...
        private static string strConnString = @"Server=MADELL\MSSQLSERVER01;Database=Sheraton;Trusted_Connection = True;";
        //@"Server=localhost;Database=Sheraton;User ID=localhost; Password=localhost";
        //
